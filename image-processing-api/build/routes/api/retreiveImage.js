...
retreiveImage.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var imageName, heightString, heightN, widthString, widthN, imageName_1, heightString_1, heightN_1, widthString_1, widthN_1, resizedImage, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                heightString_1 = req.query.height;
                heightN_1 = parseInt(heightString_1);
                widthString_1 = req.query.width;
                widthN_1 = parseInt(widthString_1);
                // resizing the image by using a module
                return [4 /*yield*/, (0, imageProcess_1.default)(imageName_1, widthN_1, heightN_1)];
            case 2:
                // resizing the image by using a module
                _a.sent();
                resizedImage = "".concat(absoluteResizedImagePath, "/").concat(imageName_1, "W").concat(widthN_1, "H").concat(heightN_1, ".jpg");
